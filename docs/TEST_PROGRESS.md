...
- [x] **Material Entry Form Flow**: Thêm vật tư, test tìm kiếm sản phẩm và nhập số lượng (`integration_test/material_entry_form_test.dart`)
...
- **Stock**: `STOCK-01`, `STOCK-03`, `STOCK-06`, `STOCK-07`
